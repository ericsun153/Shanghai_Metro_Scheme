...
let currentYear = 1862; // Start year for the animation  
const yearsData = [...Array(2024-1861).keys()].slice(1).map(it=>it + 1861); // Years for which we have w_data  
console.log(yearsData)
let yearsIndex = 40; // Index to iterate through yearsData  
...
function updateChart(year) {
    ...
    filteredData = filteredData.sort((a, b) => b.length - a.length).slice(0,12);
